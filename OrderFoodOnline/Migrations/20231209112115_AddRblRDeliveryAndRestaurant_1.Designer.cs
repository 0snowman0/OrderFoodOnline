...
namespace OrderFoodOnline.Migrations
{
    ...
    [Migration("20231209112115_AddRblRDeliveryAndRestaurant_1")]
    partial class AddRblRDeliveryAndRestaurant_1
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("OrderFoodOnline.Model.Product.Location.Location_En", b =>
                {
                    ...
                    b.Property<int>("Restaurant_En_Id")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("OrderFoodOnline.Model.Product.Location.Location_En", b =>
                {
                    b.HasOne("OrderFoodOnline.Model.User.Restaurant_En", "restaurant_En")
                        .WithMany()
                        .HasForeignKey("{Restaurant_En_Id}");
            ...
            modelBuilder.Entity("OrderFoodOnline.Model.User.Delivery_En", b =>
                {
                    b.HasOne("OrderFoodOnline.Model.User.Delivery_Restaurant_Relation_En", null)
                        .WithMany("delivery_Ens")
            ...
            modelBuilder.Entity("OrderFoodOnline.Model.User.Restaurant_En", b =>
                {
                    b.HasOne("OrderFoodOnline.Model.User.Delivery_Restaurant_Relation_En", null)
                        .WithMany("restaurant_Ens")
                        .HasForeignKey("{Restaurant_Id}");

                    b.HasOne("OrderFoodOnline.Model.Product.Location.Location_En", "location")
                        .WithMany()
